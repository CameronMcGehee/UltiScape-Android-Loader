...
public class Config {
    ...
    public static final Object[] TITLES = new Object[]{"UltiScape"};
    //The URL's of your web items
    public static final String[] URLS = new String[]{"https://www.ultiscape.com/admin/"};
